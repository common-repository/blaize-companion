										...
										<?php
											...
											switch ($field['type']) {
												...
												case 'icon':
													...
													echo '<span><i class="fa fa-arrow-down"></i></span>';
													echo '</div>';
												...
												case 'social-icon':
													echo '<div class="blz-selected-icon">';
													echo '<i class="fa '.esc_attr($new_value).'"></i>';
													echo '<span><i class="fa fa-arrow-down"></i></span>';
													echo '</div>';
													echo '<ul class="blz-icon-list clearfix">';
													$blaize_icons_array = blaize_social_iconset();
													foreach ($blaize_icons_array as $icon) {
													$icon_class = $new_value == 'fa fa-'.$icon ? 'icon-active' : '';
													echo '<li class='.$icon_class.'><i class="fa fa-'.$icon.'"></i></li>';
													}
													echo '</ul>';
													echo '<input data-default="'.esc_attr($default).'" type="hidden" value="'.esc_attr($new_value).'" data-name="'.esc_attr($key).'"/>';
													break;
